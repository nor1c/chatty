...
import { ArrowLeft, ArrowRight, BookOpen, CaretDown, Check, GameController, GearSix, ListBullets, MagnifyingGlass, Plus, Shuffle, Sparkle, SpeakerHigh, SpinnerGap, SquaresFour, Trash, Translate, X } from '@phosphor-icons/react'
