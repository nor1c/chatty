...
import { ArrowClockwise, ArrowUp, Check, Copy, Robot, Trash } from '@phosphor-icons/react'
...
const Message = memo(function Message({ message, wide = false, streaming, onRetry, onDelete, onSelectionAction }) {
