...
import { ArrowClockwise, ArrowUp, Check, Copy, Robot } from '@phosphor-icons/react'
...
const Message = memo(function Message({ message, wide = false, streaming, onRetry, onSelectionAction }) {
